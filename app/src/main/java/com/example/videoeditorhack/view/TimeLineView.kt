        ...
        BackgroundExecutor.execute(object : BackgroundExecutor.Task("", 0L, "") {
            override fun execute() {
                ...
                try {
                    ...
                    val codec264 =
                        "https://sputnikdvr1.baza.net/e344f4bb-fd97-4f7d-b12c-2aab350abcdd/index.m3u8?token=MWFkZTQwZGY4NWEwZmJmMjBjNTNlMGNiNzI1Mjc1MTI1N2M4ZWY3Ny4xNjc3MTY0MTIx"

                        mediaMetadataRetriever.setDataSource(context, Uri.parse(codec264)) //
                    ...
                    initialBitmap?.let {
                        ...
                        val frameWidth =
                            ((it.width.toFloat() / it.height.toFloat()) * frameHeight.toFloat()).toInt()
