...
import com.example.videoeditorhack.interfaces.OnCropVideoListener
import java.io.File
import java.util.*
...
//        mediaMetadataRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_WIDTH)?.let {
//            videoWidth = it.toInt()
//        }
//        mediaMetadataRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_HEIGHT)?.let {
//            videoHeight = it.toInt()
//        }
//        return this
//    }
//
